...
export default function FoodMonth() {
  return (
    <div className="FoodMonth px-[7.5%] pt-[10vh] mt-[5vh] ">
      <h1 className="text-[#000000] font-semibold font-Playfair text-[2.5rem] text-center leading-[53px] ">
        Food of the Month
      </h1>
      <p className="text-[#75797F] font-normal text-[1.1rem] text-center leading-[28px] px-[20%] pt-[2vh] ">
      ...
      <div className="text-center py-[7vh] ">
        <button className="text-[1.3rem]  font-medium text-[#FFFFFF] leading-[19px] bg-[#DF6751] hover:bg-[#FE8B75] px-[2%] py-[1.8vh] rounded-[40px] ">
            Explore our Menu
        </button>
      </div>
    </div>
