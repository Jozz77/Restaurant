export default function PartSuccessCard() {
  return (
    <div className="text-left w-[90%]">
      ...
      <button className="text-[1.2rem]  font-medium text-[#FFFFFF] leading-[27px] bg-[#DF6751] px-[3%] mt-[3vh] py-[1vh] rounded-[40px] ">Learn More</button>
    </div>
  );
}
